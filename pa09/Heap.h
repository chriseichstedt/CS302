...
class Heap
{
  public:
    ...
    // The functions necessary for insert and remove
    int getLeftChild (const int nodeIndex) const;
    int getRightChild (const int nodeIndex) const;
    int getParent (const int nodeIndex) const;
    void sortUp (const int nodeIndex);
    void sortDown (const int nodeIndex);
