...
class ExprTree {
  ...
  private:
    ...
    void copyConstructor_Helper(ExprTreeNode *&end, ExprTreeNode *start);
    void build_Helper(ExprTreeNode *&tempNode);
    void expression_Helper(ExprTreeNode *ptr) const;
    DataType evaluate_Helper(ExprTreeNode *ptr) const;
    void clear_Helper(ExprTreeNode *&ptr);
    void showHelper(ExprTreeNode *ptr, int height) const;
    void commute_Helper(ExprTreeNode *&ptr);
